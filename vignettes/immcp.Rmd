...
If the `disease_biomarker` is a a vector of logFC values named by gene symbol, you can use `method = "enrich"`, such as `disease_biomarker_gsea`.

```{r}
# "gsea" method---------------------------------------------------------------------

FP <- extrFP(disease_biomarker = drugSample$disease_biomarker_gsea,
